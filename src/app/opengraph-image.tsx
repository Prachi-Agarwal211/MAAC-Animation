...
export const alt = 'MAAC Animation Jaipur - Leading Animation & VFX Courses';
...
export default function Image() {
  return new ImageResponse(
    <div style={{ display: 'flex', width: '100%', height: '100%', backgroundColor: '#161616', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', color: '#e8a000', fontSize: 28 }}>Leading Animation, VFX & Multimedia Courses</div>
