      ...
      <main className="bg-[#080808] min-h-screen">
        ...
        <section className="py-24 md:py-32 bg-transparent relative border-b border-white/5">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="font-display text-3xl md:text-5xl text-[#F0EBE1] mb-12 font-light uppercase leading-[1.1] tracking-[0.1em]">Why Choose MAAC in Jaipur?</h2>
            <div className="prose prose-lg text-[#A8A29C] max-w-none prose-invert">
              ...
              <div className="grid md:grid-cols-2 gap-12 mt-16 not-prose">
                <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
                  <h3 className="text-[#F0EBE1] text-2xl font-display mb-4 font-light uppercase leading-[1.1] tracking-[0.1em]">Fees and Duration</h3>
                ...
                <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
                  <h3 className="text-[#F0EBE1] text-2xl font-display mb-4 font-light uppercase leading-[1.1] tracking-[0.1em]">Placement Record</h3>
                  <p className="text-[#A8A29C]">
        ...
        <section className="py-24 md:py-32 bg-transparent relative border-b border-white/5">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="font-display text-3xl md:text-5xl text-[#F0EBE1] mb-16 text-center font-light uppercase leading-[1.1] tracking-[0.1em]">
