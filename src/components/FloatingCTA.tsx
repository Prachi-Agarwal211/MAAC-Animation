    ...
    >
      ...
      <div className="relative group">
        <a
          ...
          className="fab-pulse relative flex items-center justify-center w-[52px] h-[52px] rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl transition-shadow focus:outline-none focus:ring-2 focus:ring-white/50"
        ...
        >
          ...
          <span className="absolute left-full ml-3 px-3 py-1.5 bg-white text-gray-900 text-sm font-medium rounded-md opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
            WhatsApp Us
          </span>
        </a>
      </div>
      ...
      <div className="relative group">
        <a
          ref={callRef}
          href={callUrl}
          className="fab-pulse relative flex items-center justify-center w-[52px] h-[52px] rounded-full bg-[#E31837] text-white shadow-lg hover:shadow-xl transition-shadow focus:outline-none focus:ring-2 focus:ring-white/50"
          aria-label="Call us"
