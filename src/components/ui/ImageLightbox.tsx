...
export default function ImageLightbox({
  ...
  const content = (
    ...
    >
      ...
      {/* Image counter */}
      {images.length > 1 && (
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-[10000] text-white text-sm font-bold bg-black/50 px-4 py-2 rounded-full">
          ...
          {images.map((img, idx) => (
            <button
              ...
              className={`flex-shrink-0 w-16 h-12 rounded-md overflow-hidden border-2 transition-all ${
                idx === currentIndex ? "border-[#C4A882] scale-110" : "border-transparent opacity-60 hover:opacity-100"
              }`}
