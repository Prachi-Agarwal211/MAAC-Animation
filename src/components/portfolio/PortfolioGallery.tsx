    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-[#1A1A1A]">
        ...
        <div className="absolute top-3 left-3">
          <span className="bg-[#FFD700]/90 text-white text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div className="p-4">
            <span className="text-white text-xs font-bold">Click to view portfolio</span>
          </div>
        </div>
      </div>
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="font-display text-[#F0EBE1] text-whitease mb-1.5 group-hover:text-[#FFD700] transition-colors line-clamp-1 font-black uppercase leading-[1.1] tracking-[0.1em]">
          {entry.studentName}
        </h3>
