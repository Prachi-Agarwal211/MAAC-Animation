      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {course.careers.map((career, i) => (
            <div
              key={i}
              className="bg-[#161616] rounded-xl p-6 border border-white/5 hover:border-[#E31837]/30 transition-all duration-300 group"
            >
              <div className="w-10 h-10 rounded-lg bg-[#E31837]/10 flex items-center justify-center mb-4 group-hover:bg-[#E31837]/20 transition-colors">
