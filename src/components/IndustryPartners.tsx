          ...
          <div className="flex items-center gap-8 w-max animate-marquee">
            {extendedPartners.map((partner, i) => (
              <div key={`${partner}-${i}`} className="shrink-0 group">
                <div className="w-48 h-20 md:w-56 md:h-24 glass-card border border-white/10 flex items-center justify-center px-6 transition-all duration-300 hover:border-[#FFD700]/50 hover:bg-[#FFD700]/5 hover:-translate-y-1 hover:brightness-110 hover:shadow-[0_0_25px_rgba(255,215,0,0.1)]">
