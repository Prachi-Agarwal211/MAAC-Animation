        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="font-display text-[clamp(2rem,5vw,3rem)] leading-[0.8] text-white font-bold uppercase leading-[1.1] tracking-[0.1em]">
            ...
            <span className="title-layer">
              <span className="title-layer-glow" aria-hidden="true">ECOSYSTEM</span>
              <SplitTextReveal delay={0.2} className="metallic-gold-text font-bold italic relative z-10">ECOSYSTEM</SplitTextReveal>
            </span>
          </h2>
        </div>
