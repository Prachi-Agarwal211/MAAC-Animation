      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="an-heading order-2 lg:order-1">
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              <a href="https://wa.me/911414035604" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] text-sm hover:bg-[#25D366]/20 transition-colors">
              ...
              <a href="tel:+911414035604" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#E31837]/10 border border-[#E31837]/20 text-[#E31837] text-sm hover:bg-[#E31837]/20 transition-colors">
              ...
              <a href="mailto:jaipur@maacindia.com" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-[#A8A29C] text-sm hover:bg-white/10 transition-colors">
