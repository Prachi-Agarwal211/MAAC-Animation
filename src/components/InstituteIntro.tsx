    ...
    <div className="relative z-20 bg-transparent py-16 md:py-24">
      <div className="max-w-content mx-auto px-5 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 lg:gap-20 items-center">
          ...
          {/* Left: Video */}
          <LiquidReveal className="lg:col-span-8 institute-video-container">
          ...
          <div className="lg:col-span-4">
            <div className="mb-10">
              <div className="flex items-center gap-4 mb-5">
                ...
                <span className="text-white/40 text-[9px] font-bold tracking-[0.3em] uppercase">Since 1998</span>
              </div>
            ...
            <FadeIn delay={0.2}>
              <div className="institute-description text-white/85 md:text-lg leading-relaxed mb-10">
                <p>
            ...
            <FadeIn delay={0.6} className="grid grid-cols-3 gap-4 pt-10 border-t border-white/5">
              <CountUpStat number={28} suffix="+" label="Years" />
