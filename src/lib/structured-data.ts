...
export const faqSchema = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the eligibility for animation courses at MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Eligibility varies by program at MAAC Animation Jaipur: (1) B.Voc in 3D Animation & VFX requires 10+2 completion with minimum 50% marks. (2) Diploma programs accept students aged 18+ with 10+2 or equivalent. (3) Short-term skill enhancement courses are open to anyone with basic computer knowledge. No prior artistic or technical background required for most programs."
      }
    },
    {
      "@type": "Question",
      "name": "What is the course fee for animation and VFX programs at MAAC Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Course fees at MAAC Animation Jaipur range from ₹50,000 to ₹2,50,000 depending on the program duration and specialization. B.Voc programs (3 years) cost approximately ₹1,80,000 per year. Diploma programs (18-24 months) range from ₹1,00,000 to ₹1,80,000. We offer EMI options, education loans, and merit-based scholarships. Contact us at +91-7300001589 for detailed fee structure."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Is B.Voc degree available at MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, MAAC Animation Jaipur offers B.Voc (Bachelor of Vocation) in 3D Animation & VFX, a UGC-recognized 3-year undergraduate degree. The program combines practical industry training with academic learning. Students earn multiple certifications: Advanced Diploma after 2 years, Diploma after 1 year, and B.Voc degree upon completion. This allows students to enter the workforce at multiple exit points."
      }
    },
    {
      "@type": "Question",
      "name": "What software and tools will I learn at MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "At MAAC Animation Jaipur, students gain proficiency in industry-standard software including: Autodesk Maya, 3ds Max, ZBrush for 3D modeling; Adobe After Effects, Nuke, Fusion for VFX compositing; Unreal Engine, Unity for game development; DaVinci Resolve, Premiere Pro for video editing; Photoshop, Illustrator for digital art. Our curriculum is updated regularly to include emerging technologies like AI tools, real-time rendering, and VR/AR."
      }
    },
    {
      "@type": "Question",
      "name": "Can I get a free demo class at MAAC Animation Jaipur before admission?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely! MAAC Animation Jaipur offers free demo classes so you can experience our teaching methodology, infrastructure, and software before making a decision. Schedule a demo class by calling +91-7300001589, visiting our center at Subhash Marg, Jaipur, or filling out the contact form on our website. We also offer career counseling sessions to help you choose the right course."
      }
    },
    {
      "@type": "Question",
      "name": "What is the class schedule at MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "MAAC Animation Jaipur offers flexible schedules to accommodate different needs: (1) Regular batches: Monday to Saturday, 9 AM - 12 PM or 12 PM - 3 PM. (2) Weekend batches: Saturday and Sunday, 10 AM - 4 PM for working professionals and college students. (3) Evening batches: 4 PM - 7 PM. Program durations range from 6 months (skill enhancement) to 3 years (B.Voc). Each session includes 2-3 hours of practical lab work."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Are there scholarships or financial aid available at MAAC Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, MAAC Animation Jaipur offers multiple financial support options: (1) Merit-based scholarships up to 25% fee waiver for students with exceptional academic records or creative portfolios. (2) Education loans through tie-ups with leading banks. (3) No-cost EMI options for easy monthly payments. (4) Special discounts for early admissions and group enrollments. Contact our admissions team for personalized financial planning."
      }
    },
    {
      "@type": "Question",
      "name": "How can I get admission at MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Admission at MAAC Animation Jaipur is simple and straightforward. Step 1: Visit our C-Scheme campus for a free demo class and career counseling session. Step 2: Meet our academic counselors who assess your interests and recommend the right course. Step 3: Complete the enrollment form with required documents (10+2 marksheet, ID proof). Step 4: Choose from EMI, education loan, or upfront payment options. Step 5: Begin classes with expert faculty. Call +91-7300001589 to start your journey."
      }
    },
    {
      "@type": "Question",
      "name": "What facilities does MAAC Animation Jaipur offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "MAAC Animation Jaipur offers state-of-the-art facilities including: high-performance computer labs with latest GPUs and Wacom Cintiq displays, dedicated rendering farm for 3D projects, green screen studio with professional lighting for VFX compositing, motion capture lab with industry-standard equipment, library with animation and art reference materials, and free Wi-Fi across campus. All labs have full software licenses for Maya, ZBrush, Nuke, Unreal Engine, and more."
      }
    },
    {
      "@type": "Question",
      "name": "What career opportunities are available after MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Graduates of MAAC Animation Jaipur can pursue careers as: 3D Animator, VFX Compositor, Game Designer, Motion Graphics Artist, Character Modeler, Lighting Artist, Rigging Artist, Storyboard Artist, UI/UX Designer, Video Editor, Architectural Visualizer, and Digital Content Creator. Starting salaries range from ₹3-8 LPA with top performers earning ₹8-12 LPA at studios like DNEG, MPC, Prime Focus, Ubisoft, and Technicolor."
      }
    },
    {
      "@type": "Question",
      "name": "Does MAAC Animation Jaipur offer online classes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "MAAC Animation Jaipur primarily offers on-campus classes with hands-on practical training. However, we provide blended learning support through our online learning platform for theory modules, recorded sessions, and assignments. Our main programs require in-person attendance for lab work, studio sessions, and mentorship. Contact us at +91-7300001589 for more details about current class modes."
      }
    },
    {
      "@type": "Question",
      "name": "Is MAAC Animation Jaipur NSDC certified?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, MAAC Animation Jaipur is NSDC (National Skill Development Corporation) and MESC (Media & Entertainment Skills Council) certified. This government recognition ensures that our curriculum meets industry standards and our certifications are valued by employers nationwide. The B.Voc degree programs are UGC-recognized and approved by the University Grants Commission of India."
      }
    },
    {
      "@type": "Question",
      "name": "What is the duration of animation courses at MAAC Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "At MAAC Animation Jaipur, course durations vary by program: B.Voc degree programs are 3 years (with multiple exit options after 1 year with certificate and 2 years with diploma). Advanced diploma programs like AD3D Edge Plus run for 25 months. Diploma programs like D3D, DAFM, and DGDI run for 12-18 months. Short-term certificate courses range from 3-6 months for focused skill development."
      }
    },
    {
      "@type": "Question",
      "name": "What is the alumni network of MAAC Animation Jaipur?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "MAAC Animation Jaipur has a strong alumni network of 50,000+ professionals working at top animation, VFX, and gaming studios worldwide including DNEG, MPC, Prime Focus, Technicolor, Redchillies VFX, Ubisoft, EA Games, Rockstar Games, and DQ Entertainment. Alumni receive lifetime career support, access to job postings, networking events, and mentorship opportunities through the MAAC Alumni Association."
      }
    },
    {
      "@type": "Question",
      "name": "Where is MAAC Animation Jaipur located?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "MAAC Animation Jaipur is located at 711-712, Ambition Tower, 7th Floor, D-46B, Malan Ka Chauraha, Agrasain Circle, Subhash Marg, C Scheme, Jaipur, Rajasthan 302001. The institute is in the heart of Jaipur's education district, easily accessible from all parts of the city via public transport. Landmarks include the Agrasain Circle and Subhash Marg crossing."
      }
    },
    {
      "@type": "Question",
      "name": "Does MAAC Animation Jaipur offer weekend batches?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, MAAC Animation Jaipur offers weekend batches on Saturday and Sunday from 10 AM to 4 PM. These batches are designed specifically for working professionals, college students, and anyone who cannot attend weekday classes. Weekend batch students get the same curriculum, software access, lab facilities, and placement support as regular batch students. Call +91-7300001589 to reserve your seat."
      }
    }
  ]
};
